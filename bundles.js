		...
		},
		{
				...
				items: [
					...
					},
					{
							...
							bgColor: '#FDFF00',
							fgColor: '#564E00',
							items: ['Parsnip (Gold Star) (5)', 'Melon (Gold Star) (5)', 'Pumpkin (Gold Star) (5)', 'Corn (Gold Star) (5)']
					},
					{
							heading: 'Animal Bundle (5)',
							bgColor: '#FFECD6',
							fgColor: '#D1006C',
							items: ['Large Milk', 'Large Egg (Brown)', 'Large Egg (White)', 'Large Goat Milk', 'Wool', 'Duck Egg']
					},
					{
